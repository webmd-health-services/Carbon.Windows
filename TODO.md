...
* Rename every file that has `Carbon.Windows` in its name, replacing `Carbon.Windows` with the module name.
* Replaces `Carbon.Windows` in every file with the module name.
